...
export default function MissionListItem({
  ...
  if (isComplete) {
    return (
      <div className="w-130 h-201 relative rounded-tl-lg bg-white rounded-lg mx-12 mb-8">
        <div
        ...
        <div className="w-130 h-51 flex justify-center items-center rounded-b-lg bg-white border-1 border-dubgraymedium">
        ...
        <Link href={`/dubbing/${videoId}`}>
          <div className="w-130 h-201 relative rounded-tl-lg bg-white rounded-lg mx-12 mb-8">
            ...
            >
              ...
              <div className="bg-black opacity-50 absolute top-0 left-0 w-130 h-130 rounded-t-lg"></div>
  ...
  function getBoxStyle(color: string): string {
    return `relative w-130 h-130 rounded-tl-lg rounded-tr-lg flex justify-center items-center`;
  }
}

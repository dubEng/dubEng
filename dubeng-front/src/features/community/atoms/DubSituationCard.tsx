...
export default function DubSituationCard({ type, onClick }: Iprops) {
  if (type === SituationType.PLACE_1) {
    return (
      <div
        className="flex flex-col justify-center items-center rounded-8 w-175 h-80 bg-dubcoral text-white"
        onClick={onClick}
      >
    ...
    return (
      <div
        className="flex flex-col justify-center items-center rounded-8 w-175 h-80 bg-dubivory"
        onClick={onClick}
      >
    ...
    return (
      <div
        className="flex flex-col justify-center items-center rounded-8 w-175 h-80 bg-dubblue text-white"
        onClick={onClick}
      >
    ...
    return (
      <div
        className="flex flex-col justify-center items-center rounded-8 w-175 h-80 bg-dubpink text-dubblack"
        onClick={onClick}
      >

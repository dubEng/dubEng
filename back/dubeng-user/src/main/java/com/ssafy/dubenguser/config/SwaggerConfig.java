...
public class SwaggerConfig {
    ...
    public Docket restAPI(){
        Server serverLocal = new Server("local", "http://localhost:9000", "for local useages", Collections.emptyList(), Collections.emptyList());
        ...
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ssafy.dubenguser"))
    ...
    private ApiInfo getApiInfo(){
        return new ApiInfoBuilder()
                .title("Dubeng User, Mypage REST API Server")
                .version("v0.0.1")
                .description("회원, 마이페이지 REST API")
                .build();
    }
}